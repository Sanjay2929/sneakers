            ...
            <Col md={6} data-aos="fade-up-left pt-4 pt-md-0">
              ...
              <div className="d-flex align-items-center gap-3 pt-4 pb-1">
                ...
                <div className="d-flex align-items-center counter_shoes justify-content-evenly">
                  <h4
                    className="addbtn ff_josefin fw_400 fs_20 mb-0 clr_darkgray"
                    onClick={decrease}
                  >
                    {" "}
                    &minus;{" "}
                  ...
                  <h4 className="addbtn mb-2" onClick={increase}>
                    {" "}
                    <svg
                      width="9"
                      height="8"
              ...
              <div className="d-flex align-items-center gap-4 py-3">
                ...
                <div className="d-flex align-items-center gap_5">
                  <div className="red_box d-flex justify-content-center align-items-center">
