...
import bigShoes from "../assets/img/png/red_shoes.png";
import redShoes from "../assets/img/png/red_sm_shoes.png";
import blackShoes from "../assets/img/png/black_shoes.png";
import grayShoes from "../assets/img/png/gray_sm_shoes.png";
import blackRedShoes from "../assets/img/png/black_red_shoes.png";
const Heros = () => {
        ...
        <Container>
          <Row className="align-items-center  py_88_81">
            <Col md={6}>
              ...
              >
                <div className="show_img d-flex justify-content-center align-items-center overflow-hidden shoesImg cursior_pointer">
                  <img className="scale_img w-100" src={bigShoes} alt="shoes" />
                </div>
                <div className="d-flex justify-content-between mt_30 gap-4">
                  <div className="cursior_pointer">
                    <img className="w-100" src={blackShoes} alt="shoes" />
                  </div>
                  <div className="cursior_pointer">
                    <img className="w-100" src={redShoes} alt="shoes" />
                  </div>
                  <div className="cursior_pointer">
                    <img className="w-100" src={grayShoes} alt="shoes" />
                  </div>
                  <div className="cursior_pointer">
                    <img className="w-100" src={blackRedShoes} alt="shoes" />
                  </div>
                </div>
              </div>
            </Col>
            <Col md={6} data-aos="fade-up-left ">
              <h1 className="fw_600 ff_poppins fs_30 clr_black pb-3 pt-4 pt-md-0">
                PREMIUM MENS SPORTS LATHER KEDS
              </h1>
              <div className=" d-flex gap_10 align-items-center pb-4">
                <div className="d-flex gap_2">
                  <svg
                    width="19"
                    height="18"
                    viewBox="0 0 19 18"
                ...
                <h4 className="mb-0 fw_400 fs_20 ff_poppins clr-black clr_brown">
                  ( 5 Customer Review )
                </h4>
              </div>
              <p className="fw_400 fs_20 ff_poppins clr_brown lh_37 pt-1 pb-xl-5">
              ...
              <div className="d-flex align-items-center gap-3 pt-4 pb-1">
                <h4 className="mb-0 ff_poppins fw_500 fs_20 clr_black pe-1">
                  Qty:{" "}
                </h4>
                <div className="d-flex align-items-center counter_shoes justify-content-evenly">
                  <button
                    className=" ff_josefin fw_400 fs_20 mb-0 clr_darkgray cursior_pointer bg-transparent border-0"
                    onClick={decrease}
                  >
                    {" "}
                    &minus;{" "}
                  </button>
                  <h4 className="ff_josefin fw_400 fs_20 mb-0 clr_darkgray">
                    {first}{" "}
                  </h4>
                  <button
                  ...
                  >
                    ...
                    >
                      <path
                        d="M3.54 0.68H5.24V3.5H8.04V5.14H5.24V7.96H3.54V5.14H0.76V3.5H3.54V0.68Z"
                        fill="#555555"
                      />
                    </svg>
                  </button>
                ...
                <button
                  className="addCart ff_poppins fs_20 fw_500 clr_white border-0 addbtn"
                  onClick={one}
                >
                  Add&nbsp;to&nbsp;Cart
                </button>
              </div>
              <div className="d-flex align-items-center mb-0 gap-3 pt-lg-3 pt-2 pb-1">
                <h4 className="fw_500 fs_20 clr_black ff_poppins mb-0">
                  Size:{" "}
                </h4>
                <div class="dropdown px_13_19">
                  <button class="dropbtn fw_400 fs_20 ff_josefin">
                    S{" "}
                    <span className="ps_58">
                      <svg
                        width="14"
                        height="8"
                        viewBox="0 0 14 8"
              ...
              <div className="d-flex align-items-center gap-4 py-3">
                ...
                <div className="d-flex align-items-center gap_5">
                  <div className="red_box d-flex justify-content-center align-items-center cursior_pointer">
                    <div className="bg_red"></div>
                  </div>
                  <div className="red_box d-flex justify-content-center align-items-center cursior_pointer">
                    <div className="bg_greenGray"></div>
                  </div>
                  <div className="red_box d-flex justify-content-center align-items-center cursior_pointer">
                    <div className="box_bg_black"></div>
                  </div>
                  <div className="red_box d-flex justify-content-center align-items-center cursior_pointer">
                    <div className="box_bg_gray"></div>
                  </div>
                </div>
              </div>
              <div className="d-flex align-items-center gap_32 pt-3 pb-2 ">
                <div className="d-flex align-items-center gap-1 cursior_pointer">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                ...
                <div className="d-flex align-items-center gap-1 cursior_pointer">
                  ...
                  >
                    <path
                      opacity="0.6"
                      d="M10.5006 18.0258L10.1526 17.7358C2.67062 11.6458 0.640625 9.4998 0.640625 6.0198C0.640625 3.1198 2.96062 0.799805 5.86062 0.799805C8.23862 0.799805 9.57263 2.1338 10.5006 3.1778C11.4286 2.1338 12.7626 0.799805 15.1406 0.799805C18.0406 0.799805 20.3606 3.1198 20.3606 6.0198C20.3606 9.4998 18.3306 11.6458 10.8486 17.7358L10.5006 18.0258ZM5.86062 1.9598C3.59862 1.9598 1.80062 3.7578 1.80062 6.0198C1.80062 8.9778 3.65662 10.9498 10.5006 16.5178C17.3446 10.9498 19.2006 8.9778 19.2006 6.0198C19.2006 3.7578 17.4026 1.9598 15.1406 1.9598C13.1106 1.9598 12.0086 3.1778 11.1386 4.1638L10.5006 4.9178L9.86262 4.1638C8.99262 3.1778 7.89062 1.9598 5.86062 1.9598Z"
                      fill="black"
                    />
                  </svg>
                  <h4 className=" ff_poppins fw_300 fs_16 clr_22 mb-0 lh_20">
              ...
              {/* SOCIAL ICONS */}
              <div className="d-flex align-items-center gap_35 ">
